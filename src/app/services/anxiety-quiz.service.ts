...
//     this.feedbackMessage = '';
//     this.showFeedback = true;
//     this.fetchQuestions().subscribe(questions => {
...
//   }
//
//   submitAnswer(questionIndex: number, selectedOption: number): Observable<any> {
//     const payload = { questionIndex, selectedOption };
//     return this.http.post(`${this.apiUrl}/answer`, payload).pipe(
//       catchError(error => {
